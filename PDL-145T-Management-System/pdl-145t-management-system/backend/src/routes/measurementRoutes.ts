...
router.post(
  ...
  authenticateJWT,
  requireConstruction,
  validateSchema(MeasurementCreateSchema, 'body'),
  createMeasurement
);
...
router.put(
  ...
  authenticateJWT,
  requireAdminOrSupervisor,
  validateSchema(MeasurementParamsSchema, 'params'),
  validateSchema(MeasurementUpdateSchema, 'body'),
  updateMeasurement
);
