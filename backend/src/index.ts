...
import taskResourceRoutes from './routes/taskResourceRoutes.js';
import siteResourceRoutes from './routes/siteResourceRoutes.js';
...
app.use('/api/task-resources', taskResourceRoutes);
app.use('/api/site-resources', siteResourceRoutes);
