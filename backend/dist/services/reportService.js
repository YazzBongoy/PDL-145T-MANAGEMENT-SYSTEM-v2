...
export class ReportService {
    ...
    async getReportsByValidation(validationId) {
        return await prisma.report.findMany({
    ...
    async getReportsPaginated(page = 1, limit = 10, sortBy = 'Timestamp', sortOrder = 'desc') {
    ...
    async generateBillingReport(projectId) {
