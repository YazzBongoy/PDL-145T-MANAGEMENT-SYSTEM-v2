...
- Name: programs-hierarchy.spec.ts >> 🎯 PDL 145 - Programme, Projets et Hiérarchie des Tâches >> ✅ 6. Vérification de la hiérarchie des Tâches - Niveau 1
- Location: tests/programs-hierarchy.spec.ts:145:3
...
Locator: locator('[data-testid="task-hierarchy"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="task-hierarchy"]')
