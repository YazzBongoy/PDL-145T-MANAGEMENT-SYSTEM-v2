...
- Name: programs-hierarchy.spec.ts >> 🎯 PDL 145 - Programme, Projets et Hiérarchie des Tâches >> ✅ 2. Vérification du Programme PDL 145 Territoires
- Location: tests/programs-hierarchy.spec.ts:37:3
...
Locator: locator('[data-testid="program-card"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="program-card"]').first()
