...
interface ApprovalQueueProps {
  // userRole prop removed - not used in component
}
...
export const ApprovalQueue: React.FC<ApprovalQueueProps> = () => {
  ...
  const handleSubmitApproval = async (expenseId: number) => {
    ...
    const approval = approvals.find((a: PendingApproval) => a.expenseId === expenseId);
  ...
  if (error) {
    ...
    return <div className="approval-queue error">Error loading approvals: {errorMsg}</div>;
  }
